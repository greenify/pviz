 ...
 */
define(['jquery', 'underscore', 'backbone', './models/SeqEntry', './services/DASReader', './views/SeqEntryFastaView', './views/SeqEntryAnnotInteractiveView', './views/SeqEntryTableView'], function($, _, Backbone, SeqEntry, DasReader, SeqEntryFastaView, SeqEntryAnnotInteractiveView, SeqEntryTableView) {
